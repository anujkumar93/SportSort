...
numSecondsPerImage = 30  # make sure this is same as secondsToKeep in DataPrepocessing.py
numColumns = (numSecondsPerImage-fftWidth)/fftJump+1    # total no of columns to include in one image
firstNtoIgnore = 20      # first N indices of fft data of all sensors to set to zero (values tend to blow up there)
################################################################
...
for ind in range(len(sports)):
    ...
    print 'intermediateOutputLabels.shape:', intermediateOutputLabels.shape
